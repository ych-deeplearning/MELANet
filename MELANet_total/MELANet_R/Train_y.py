...
def train(train_loader, model, optimizer, epoch, save_path, writer):
    ...
    try:
        for i, (images, gts, edges) in enumerate(train_loader, start=1):
            ...
            loss_edge = dice_loss(preds[3], edges)*0.125 + dice_loss(preds[4], edges)*0.25 + \
                        dice_loss(preds[5], edges)*0.5
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='/home/dell/User_student/ych/TrainDataset/',
